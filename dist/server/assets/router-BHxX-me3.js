...
const appCss = "/assets/styles-BfhViPSz.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Oakland The Global School | Premier Preschool & Daycare in Visakhapatnam"
      },
      {
        name: "description",
        content: "Oakland The Global School: Premier preschool & daycare in Visakhapatnam. Play Group to Grade 2 with Montessori-inspired learning, safe campus, trained educators, and activity-based curriculum. Admissions open for 2024-25."
      },
      {
        name: "keywords",
        content: "preschool visakhapatnam, daycare visakhapatnam, montessori school, early childhood education, play group, nursery school, kindergarten, grade 1, grade 2, best preschool visakhapatnam, oakland global school"
      },
      ...
      {
        property: "og:title",
        content: "Oakland The Global School | Premier Preschool & Daycare in Visakhapatnam"
      },
      {
        property: "og:description",
        content: "Nurturing young minds for a global future. Montessori-inspired learning, safe campus, trained educators. Admissions open for Play Group to Grade 2."
      },
      ...
      { property: "og:image:height", content: "630" },
      {
        ...
        content: "Oakland The Global School - Premier Preschool in Visakhapatnam"
      },
      ...
      {
        name: "twitter:title",
        content: "Oakland The Global School | Premier Preschool & Daycare in Hyderabad"
      },
      {
        name: "twitter:description",
        content: "Nurturing young minds for a global future. Montessori-inspired learning, safe campus, trained educators. Admissions open."
      },
      {
        name: "twitter:image",
        content: "https://oakland.theglobalschool.workers.dev/oak-hero.jpg"
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Premier preschool and daycare in Visakhapatnam offering Montessori-inspired early childhood education from Play Group to Grade 2.",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: "Oakland The Global School",
          url: "https://oakland.theglobalschool.workers.dev/",
          description: "Premier preschool and daycare in Visakhapatnam offering Montessori-inspired early childhood education",
          publisher: {
            "@type": "EducationalOrganization",
            name: "Oakland The Global School"
          },
          potentialAction: {
            "@type": "SearchAction",
            target: "https://oakland.theglobalschool.workers.dev/search?q={search_term_string}",
...
const $$splitComponentImporter = () => import("./index-BoAfuGPM.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  head: () => ({
    meta: [{
      name: "description",
      content: "Oakland The Global School: Premier preschool & daycare in SujathaNagar,Visakhapatnam. Play Group to Grade 2 with Montessori-inspired learning, safe campus, trained educators. Admissions open for 2026-27."
    }, {
      name: "keywords",
      content: "preschool SujathaNagar Visakhapatnam, daycare SujathaNagar Visakhapatnam, montessori school, early childhood education, play group, nursery school, kindergarten, grade 1, grade 2, best preschool sujatha nagar,visakhapatnam"
    }, {
      property: "og:title",
      content: "Oakland The Global School | Premier Preschool & Daycare in SujathaNagar,Visakhapatnam"
    }, {
      property: "og:description",
      content: "Nurturing young minds for a global future. Montessori-inspired learning, safe campus, trained educators. Admissions open for Play Group to Grade 2."
    }, {
      ...
      name: "twitter:description",
      content: "Nurturing young minds for a global future. Montessori-inspired learning, safe campus, trained educators. Admissions open for 2026-27."
    }]
  })
});
